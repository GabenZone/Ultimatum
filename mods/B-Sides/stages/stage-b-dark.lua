function onCreate()
	if not lowQuality then
		...
		makeLuaSprite('lightBeams', 'stages/week1/lightBeams', -50, -25);
		makeLuaSprite('curtains-dark', 'stages/week1/curtains-dark', -400, -400);

		makeLuaSprite('curtains', 'stages/week1/curtains', -400, -400);
		makeLuaSprite('lights-dark', 'stages/week1/lights-dark', -250, -150);
	end
	...
	makeLuaSprite('wall-dark', 'stages/week1/wall-dark', -600, -300);

	makeAnimatedLuaSprite('floor-dark', 'stages/week1/floor-dark', -650, 600);
