...
function onCreate()
	makeLuaSprite('stagehenry', 'stagehenry', -1600, -300)
	
	
	makeAnimatedLuaSprite('gf', 'gf', 525, 230);
	scaleObject('gf', 1, 1);
	addAnimationByPrefix('gf', '', '', 24, true);
	setScrollFactor('gf', 1, 1);
	setProperty('gf.antialiasing', true);
	
	makeAnimatedLuaSprite('stickmin', 'pets/stickmin', 1480, 850);
	scaleObject('stickmin', 0.7, 0.7);
	addAnimationByPrefix('stickmin', '', '', 24, true);
	setScrollFactor('stickmin', 1, 1);
	setProperty('stickmin.antialiasing', true);

addLuaSprite('stagehenry', false);
addLuaSprite('gf', false);
addLuaSprite('stickmin', false)
end
