function onCreate()                       makeLuaSprite('fgPlatform', 'danger/fgPlatform', -850, 280);
    ...
    scaleObject('back', 2, 2);	
     ...
     makeLuaSprite('speedlines', 'danger/speedlines', -1050, -1280);
	...
	makeAnimatedLuaSprite('bf_legs', 'characters/bf_legs', 1555, 440);
