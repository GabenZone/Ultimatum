...
function onCreatePost()
    ...
    makeLuaSprite('j', 'black', -950, -200)
    addLuaSprite('j', false)
    setScrollFactor('j', 1, 1)
    scaleObject('j', 3, 3);
    setProperty('j.alpha', 0.55)
    
    makeLuaSprite('bg1', 'iluminao omaga', -595, 200)
    addLuaSprite('bg1', true)
    setScrollFactor('bg1', 1, 1)
    scaleObject('bg1', 1, 1);
    
    makeLuaSprite('bg2', 'finale/bgg', -600, -400)
    ...
    makeLuaSprite('bg6', 'finale/fore', -850, 160);
    ...
    makeLuaSprite('dark', 'finale/dark', -1820, -600);
    addLuaSprite('dark', true)
    setScrollFactor('dark', 1, 1)
    scaleObject('dark', 1.5, 1.5);
    
    makeAnimatedLuaSprite('light', 'finale/light', -400, -200)
    setScrollFactor('light', 1, 1)
    scaleObject('light', 1.1, 1.1);
    addAnimationByPrefix('light', 'light', 'light', 16, true)
    ...
    setObjectCamera('healthBarFinaleBlue', 'other')
    scaleObject("healthBarFinaleBlue", 0.7, 0.6)
    addLuaSprite('healthBarFinaleBlue', false)
   
    setObjectCamera('healthBarFinale', 'other')
    scaleObject("healthBarFinale", 0.7, 0.6)
    addLuaSprite('healthBarFinale', false)
    
    setProperty('healthBarFinaleBlue.visible', false)
    setProperty('healthBarFinale.visible', false)
    
    makeAnimatedLuaSprite('blackIcon', 'icons/icon-blackFinale', getProperty('iconP2.x')+120, getProperty('iconP2.y')-135)
    addLuaSprite('blackIcon', true)
    setScrollFactor('blackIcon', 1, 1)
    scaleObject('blackIcon', 0.8, 0.8);
    setObjectCamera('blackIcon', 'other')
    addAnimationByPrefix('blackIcon', 'normal', 'black icon calm', 24, true)
    addAnimationByPrefix('blackIcon', 'losing', 'black icon mad', 24, true)
...
function onStepHit()
	...
	if curStep == 1984 then
	    ...
	    setProperty('flashred2.alpha', 1)
	    doTweenAlpha('flTw5', 'flashred2', 0, 5, 'linear') 
	end
end
...
function onBeatHit()
	...
	if getProperty('health') >= 1.725 then
        objectPlayAnimation('blackIcon', 'losing', true);
    else
