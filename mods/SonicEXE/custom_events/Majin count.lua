...
function onCreate()
    makeLuaSprite('MajinCount1', 'FunInfiniteStage/three', 250, 50)
    setScrollFactor('MajinCount1', 0, 0)
    setObjectCamera('MajinCount1', 'other')

    makeLuaSprite('MajinCount2', 'FunInfiniteStage/two', 250, 50)
    setScrollFactor('MajinCount2', 0, 0)
    setObjectCamera('MajinCount2', 'other')


    makeLuaSprite('MajinCount3', 'FunInfiniteStage/one', 250, 50)
    setScrollFactor('MajinCount3', 0, 0)
    setObjectCamera('MajinCount3', 'other')

    makeLuaSprite('MajinCount4', 'FunInfiniteStage/gofun', 250, 50)
