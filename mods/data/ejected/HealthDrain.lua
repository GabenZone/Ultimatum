...
--推条
local ElongNoteHealthDrain = .0035 --敌方长条的扣血强度(Easy难度)
local EnoteHealthDrain = .005		--敌方单个键的扣血强度(Easy难度)


local NlongNoteHealthDrain = .0068 --敌方长条的扣血强度(Normal难度)
local NnoteHealthDrain = .01		--敌方单个键的扣血强度(Normal难度)


local HlongNoteHealthDrain = .0085 --敌方长条的扣血强度(Hard难度)
local HnoteHealthDrain = .0090		--敌方单个键的扣血强度(Hard难度)
