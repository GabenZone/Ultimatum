...
--fake 3d oooo
    ...
    setCharacterX('boyfriend',570 + zoomshit)
    setCharacterY('boyfriend',300 + zoomshit)
    setProperty('boyfriend.scale.x',2*zoomshit)
    setProperty('boyfriend.scale.y',2*zoomshit)
end