...
local barDraining;
function onCreate()
 precachedImage("characters/Heartbroken")
 precachedImage("characters/Monster_B3_GF")
 precachedImage("characters/monster_zombie")
 precachedImage("characters/Zombie_Mia")
end
